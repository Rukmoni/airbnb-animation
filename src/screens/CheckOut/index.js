...
export default class CheckOut extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    BackHandler.addEventListener("hardwareBackPress", function () {
      that.props.navigation.navigate("Mart");
      return true;
    });
  }
  ...
  _renderActiveComponent = () => {
    ...
    if (selectedStep === 1) {
      return (
        <ScrollView
          ...
          style={styles.contentBillingInformationBg}
        >
              ...
              <View style={styles.modalView}>
                <View style={styles.modal}>
                  ...
                  <View style={{ maxHeight: Metrics.HEIGHT * 0.6 }}>
                    <ScrollView style={styles.editInfoListBg}>
    ...
    if (selectedStep === 2) {
      return (
        ...
        >
          <View style={{ marginTop: Metrics.HEIGHT * 0.05, flex: 1 }}>
            <ScrollView>
  ...
  onItemClick() {
    this.props.navigation.navigate("Mart");
  }
